...
__webpack_require__.d(components_namespaceObject, "AddressInput", function() { return components_AddressInput; });
__webpack_require__.d(components_namespaceObject, "Badge", function() { return components_Badge; });
__webpack_require__.d(components_namespaceObject, "ExternalLink", function() { return components_ExternalLink; });

// EXTERNAL MODULE: ./node_modules/babel-runtime/core-js/object/assign.js
var object_assign = __webpack_require__(52);
var assign_default = /*#__PURE__*/__webpack_require__.n(object_assign);

// EXTERNAL MODULE: ./src/scss/buefy-build.scss
var buefy_build = __webpack_require__(61);
var buefy_build_default = /*#__PURE__*/__webpack_require__.n(buefy_build);

// EXTERNAL MODULE: ./src/components/AddressInput/AddressInput.vue
var AddressInput = __webpack_require__(63);
var AddressInput_default = /*#__PURE__*/__webpack_require__.n(AddressInput);
...
// CONCATENATED MODULE: ./src/components/AddressInput/index.js
...
var Plugin = {
    install: function install(Vue) {
        registerComponent(Vue, AddressInput_default.a);
    }
};

use(Plugin);

/* harmony default export */ var components_AddressInput = (Plugin);


// EXTERNAL MODULE: ./src/components/Badge/Badge.vue
var Badge = __webpack_require__(88);
...
var Badge_Plugin = {
    install: function install(Vue) {
        registerComponent(Vue, Badge_default.a);
    }
};

use(Badge_Plugin);

/* harmony default export */ var components_Badge = (Badge_Plugin);


// EXTERNAL MODULE: ./src/components/ExternalLink/ExternalLink.vue
var ExternalLink = __webpack_require__(120);
...
var ExternalLink_Plugin = {
    install: function install(Vue) {
        registerComponent(Vue, ExternalLink_default.a);
    }
};

use(ExternalLink_Plugin);

/* harmony default export */ var components_ExternalLink = (ExternalLink_Plugin);
...
var config_setOptions = function setOptions(options) {
    config = options;
};
...
var Buefy = {
    install: function install(Vue) {
        ...
        // Options
        config_setOptions(assign_default()(utils_config, options));
        // Components
...
var lodash_debounce = __webpack_require__(66);
...
// CONCATENATED MODULE: ./src/utils/unique-id.js
function generateUniqueId() {
  return 'id-' + Math.random().toString(36).substring(7);
}

/* harmony default export */ var unique_id = (generateUniqueId);
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/AddressInput/AddressInput.vue
//
//
//
//
...
/* harmony default export */ var AddressInput = __webpack_exports__["default"] = ({
  name: 'AddressInput',
  props: ['widthFromConfig', 'placeholder'],
  data: function data() {
    var data = {
      containerStyle: {
        'width': '305px'
  ...
  methods: {
    didType: lodash_debounce_default()(function (e) {
    ...
    getCandidates: function getCandidates(address) {
      ...
      axios_default.a.get('https://cqvfg1pm72.execute-api.us-east-1.amazonaws.com/dev/first-api-test/', {
        params: {
          address: address
        }
      }).then(this.didGetCandidates).catch(this.didGetCandidatesError);
    },
    didGetCandidates: function didGetCandidates(res) {
      ...
      var matchesArray = matches.map(function (x) {
        return x.address;
      });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: 'pvc-search-control-container ' + this.containerClass,
    style: (this.containerStyle)
  }, [_c('form', {
    staticClass: "pvc-search-control-form",
    attrs: {
      "autocomplete": "off",
      "id": "search-form"
    },
    on: {
      "submit": function($event) {
        ...
        _vm.handleSearchFormSubmit($event)
      }
    }
  }, [_c('input', {
    class: 'pvc-search-control-input ' + this.inputClass,
  ...
  })]), _vm._v(" "), (this.addressEntered != '' && this.addressEntered != null) ? _c('button', {
    class: 'pvc-search-control-button ' + this.buttonClass,
    on: {
      "click": _vm.handleFormX
    }
  ...
  })], 1), _vm._v(" "), _vm._t("address-candidates-slot")], 2)
},staticRenderFns: []}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    evaluateSlot: function evaluateSlot(valOrGetter) {
      ...
      var valOrGetterType = typeof valOrGetter === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_typeof___default()(valOrGetter);
      var val = void 0;
      ...
      var _loop = function _loop(transformKey) {
        ...
        if (globalKeys) {
          globals = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(window).filter(function (key) {
      ...
      try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default()(transforms), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "mb-badge panel"
  }, [_c('div', {
    staticClass: "mb-badge-header",
    style: (_vm.style)
  }, [_vm._v("\n      " + _vm._s(_vm.evaluateSlot(_vm.slots.title)) + "\n    ")]), _vm._v(" "), _c('div', {
    staticClass: "mb-badge-body"
  }, [_c('h1', [_vm._v(_vm._s(_vm.evaluateSlot(_vm.slots.value)))]), _vm._v(" "), _c('strong', [_vm._v(_vm._s(_vm.evaluateSlot(_vm.slots.description)))])])]), _vm._v(" "), (_vm.options && _vm.options.externalLink) ? _c('external-link', {
    attrs: {
      "options": _vm.options.externalLink,
      "type": 'badge'
    }
  }) : _vm._e()], 1)
},staticRenderFns: []}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TopicComponent_vue__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TopicComponent_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__TopicComponent_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__TopicComponent_vue___default.a],
